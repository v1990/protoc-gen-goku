...
func (t *FileDescriptorProto) ExportFields() map[string]interface{} {
	return map[string]interface{}{
		"Name":             t.Name(),
		"Package":          t.Package(),
		"Dependency":       t.Dependency(),
		"PublicDependency": t.PublicDependency(),
		"WeakDependency":   t.WeakDependency(),
		"MessageType":      t.MessageType(),
		"EnumType":         t.EnumType(),
		"Service":          t.Service(),
		"Extension":        t.Extension(),
		"Options":          t.Options(),
		"SourceCodeInfo":   t.SourceCodeInfo(),
		"Syntax":           t.Syntax(),
	}
}
